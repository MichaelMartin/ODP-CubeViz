...
class CubevizController extends OntoWiki_Controller_Component 
{
    ...
    public function modelinfoAction()
    {
        ...
        if (null !== $model) {
            ...
            $this->view->sparqlService = "No SPARQL service available";
            $this->view->modelTitle = "No Title available";
            $this->view->modelDescriptions = array("Maybe your session is lost");
            $this->view->containsDataCubeInformation = false;
        }
    }
